...
//                .fetchTraderContact("TraderContact", "Id =" + DataSaver.getMettingCustomerInfo().TraderId, "", AppInfoUtil.getToken())
//                .compose(bindToLifecycle())
//                .subscribeOn(Schedulers.newThread())
//                .observeOn(AndroidSchedulers.mainThread())
...
//                            loginPwd = traderContactEntity.Value.card_password;
//                            LogUtils.e("已设置登录密码：" + loginPwd);
//                            startActivity(new Intent(LoginActivity.this, MainActivity.class));
//                            finish();
//                        } else {
//                            LogUtils.e("未设置登录密码");
