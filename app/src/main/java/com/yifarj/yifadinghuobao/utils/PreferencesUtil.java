 ...
 * <li>get string {@link #getString(String)},
 * {@link #getString(String, String)}</li>
 * <li>get int {@link #getInt(String)},
 * {@link #getInt(String, int)}</li>
 * <li>get long {@link #getLong(String)},
 * {@link #getLong(String, long)}</li>
 * <li>get float {@link #getFloat(String)},
 * {@link #getFloat(String, float)}</li>
 * <li>get boolean {@link #getBoolean(String)},
 * {@link #getBoolean(String, boolean)}</li>
 * </ul>
 */
public class PreferencesUtil {

	public static String PREFERENCE_NAME = "YifaDingHuoBao";
